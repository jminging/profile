...
const KEY_LIST = ['YSF', 'CookiesLYH', 'Boc', 'CaiYun', 'meituanCookie', 'fmz200_meituan_cookie', 'ADriveCheckIn', '#meituanCookie'];

const _server = $.getval('cookie_save_url');
const _usr = $.getval('cookie_save_username');
const _pwd = $.getval('cookie_save_password');
...
function login() {
	const url = `${_server}/open/auth/token?client_id=${_usr}&client_secret=${_pwd}`
